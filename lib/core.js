...
function MouthPyc(options) {
    ...
    eventEmitter.on("added", function () {
        console.log("new item added");
        //Call Speak method if current status is inactive
        _this.state.active == false ? _this.speak() : null;
    });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        processedItem = this.state.queue[0];
                        return [4 /*yield*/, exec("say -v Samantha \"" + processedItem.message + "\"")];
                    case 1:
                        _a.sent();
                        console.log("Waiting for " + processedItem.delay + " ");
                        return [4 /*yield*/, timeout(processedItem.delay)];
                    case 2:
                        _a.sent();
